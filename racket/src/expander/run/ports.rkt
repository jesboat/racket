...
;; this is a copy of `racket/port`, but with all the contract-out exports
;; (and the corresponding require of racket/contract) removed because
;; contracts are mostly incompatible with extraction.
