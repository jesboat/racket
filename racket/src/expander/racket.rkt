...
(require racket/cmdline
         ...
         #;(only-in "common/set.rkt")
         "main.rkt"
         #;(only-in "namespace/namespace.rkt")
         "common/module-path.rkt"
         "eval/module-read.rkt"
         #;(only-in "compile/linklet-api.rkt")
         #;(only-in "boot/kernel.rkt")
         "run/cache.rkt"
         #;(only-in "boot/runtime-primitive.rkt")
         "run/status.rkt"
         #;(only-in "run/submodule.rkt")
...
(current-library-collection-paths (find-library-collection-paths))
(current-library-collection-links (find-library-collection-links))
...
(parameterize ([current-command-line-arguments (list->vector args)])
  ...
  (unless (or startup-module load-file)
    (error 'racket.rkt "must specify either startup module or load file")))
