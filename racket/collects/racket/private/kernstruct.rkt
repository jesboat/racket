;; This file was generated by makeexn and then manually hacked up
;; by jsailor to make extraction work. This "solution" should be
;; taken out back and shot but for now it's pragmatic.
;;----------------------------------------------------------------------
...
(module kernstruct '#%kernel
  ...
  (begin
    ...
    (define (make-exn:fail:syntax . a) (apply kernel:exn:fail:syntax a))
  ...
  (begin
    ...
    (define (make-exn:fail:syntax:unbound . a) (apply kernel:exn:fail:syntax:unbound a))
  ...
  (begin
    ...
    (define (make-exn:fail:syntax:missing-module . a) (apply kernel:exn:fail:syntax:missing-module a))
  ...
  (begin
    ...
    (define (make-exn:fail:filesystem:missing-module . a) (apply kernel:exn:fail:filesystem:missing-module a))
